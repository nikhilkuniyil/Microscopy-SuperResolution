...
from microscopy_sr.train import build_loaders, build_system, run_epoch, save_checkpoint
...
def main() -> None:
    ...
    out_dir = cfg["train"].get("checkpoint_dir", "checkpoints/base")
    ...
    for epoch in range(epochs):
        ...
        ckpt = save_checkpoint(model, optimizer, epoch, out_dir)
        if val_loss < best_val:
            best_val = val_loss
            print(f"new_best: {ckpt}")
